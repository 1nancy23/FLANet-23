...
class Offset_loss(nn.Module):
    ...
    def forward(self, target, pre_offset):
        ...
        off_loss = nn.SmoothL1Loss(reduction='sum')
...
class Change_channels(nn.Module):
    def __init__(self):
        ...
        # self.layer12 = nn.Conv2d(in_channels=512, out_channels=256, kernel_size=1)  # C9:W*H*512 => W*H*256
        # self.layer13 = nn.Conv2d(in_channels=512, out_channels=256, kernel_size=1)  # C9:W*H*512 => W*H*256
        # self.layer14 = nn.Conv2d(in_channels=512, out_channels=256, kernel_size=1)  #
